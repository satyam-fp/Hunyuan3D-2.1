...
# bpy is imported lazily in convert_obj_to_glb since it requires Blender
...
def convert_obj_to_glb(
    ...
    Note: This function requires Blender's bpy module to be available.
    If bpy is not installed, this function will return False.
    """
    try:
        import bpy
    except ImportError:
        print("Warning: bpy module not available. GLB export requires Blender.")
        return False
