...
# =============================================================================
echo ""
echo "[Step 1/9] Setting up conda environment '$CONDA_ENV_NAME' with Python $PYTHON_VERSION..."
...
# =============================================================================
echo ""
echo "[Step 2/9] Installing PyTorch 2.9+ with CUDA 12.8 for Blackwell GPU support..."
...
# =============================================================================
echo ""
echo "[Step 3/9] Installing pip requirements..."
...
# =============================================================================
echo ""
echo "[Step 4/9] Installing CUDA $CUDA_VERSION toolkit via conda..."
...
# =============================================================================
echo ""
echo "[Step 5/9] Installing GCC $GCC_VERSION from conda-forge..."
...
# =============================================================================
echo ""
echo "[Step 6/9] Creating compiler symlinks..."
...
# =============================================================================
echo ""
echo "[Step 7/9] Building CUDA extensions for Blackwell..."
...
# =============================================================================
echo ""
echo "[Step 8/9] Downloading RealESRGAN checkpoint..."
...
# =============================================================================
echo ""
echo "[Step 9/9] Downgrading NumPy for onnxruntime compatibility..."
...
echo "  python run_texture_gen.py --mesh <mesh> --image <image> --prompt 'your prompt' --output ./outputs --no_glb"
echo ""
